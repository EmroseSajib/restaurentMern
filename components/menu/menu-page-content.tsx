...
export function MenuPageContent() {
  ...
  // Example subcategory labels
  const subcategoryLabels: Record<string, Record<typeof locale, string>> = {
  ...
  const groupedItems = useMemo(() => {
    const groups: Record<string, Record<string, typeof filteredItems>> = {};
