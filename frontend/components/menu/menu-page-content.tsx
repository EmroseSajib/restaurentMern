...
//       items = items.filter(
//         (item) =>
//           item.name[locale].toLowerCase().includes(query) || item.description[locale].toLowerCase().includes(query),
//       )
//     }
...
//                 type="search"
//                 placeholder={
//                   locale === "nl" ? "Zoek gerechten..." : locale === "de" ? "Gerichte suchen..." : "Search dishes..."
//                 }
//                 value={searchQuery}
...
//                 activeCategory === "all" ? "bg-amber-500 text-white" : "bg-amber-100 text-amber-800 hover:bg-amber-200",
//               )}
//             >
//               {categoryLabels.all}
//             </button>
...
//                 className={cn(
//                   "px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-colors",
//                   activeCategory === key ? "bg-amber-500 text-white" : "bg-amber-100 text-amber-800 hover:bg-amber-200",
//                 )}
//               >
//                 {categoryLabels[key]}
//               </button>
...
//                     <h2 className="text-2xl font-bold text-amber-900">{categoryLabels[category as MenuCategory]}</h2>
//                     <div className="flex-1 h-px bg-amber-200" />
//                     <Badge variant="secondary" className="bg-amber-100 text-amber-800">
//                       {items.length} {locale === "nl" ? "gerechten" : locale === "de" ? "Gerichte" : "dishes"}
//                     </Badge>
//                   </div>
//                 )}
